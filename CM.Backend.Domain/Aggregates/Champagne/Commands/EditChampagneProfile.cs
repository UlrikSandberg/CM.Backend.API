...
{
    public class EditChampagneProfile
    {
	    ...
	    public EditChampagneProfile(string appearance, string blendInfo, string taste, string foodPairing, string aroma, string bottleHistory, Dosage dosage, Style style, Character character, RedWineAmount redWineAmount, ServingTemp servingTemp, AgeingPotential ageingPotential, ReserveWineAmount reserveWineAmount, DosageAmount dosageAmount, AlchoholVol alchoholVol, GrapeAmount pinotNoir, GrapeAmount pinotMeunier, GrapeAmount chardonnay)
	    {
