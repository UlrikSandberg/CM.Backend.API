...
{
	public class ChampagneFolderCreated : DomainEvent
	{
		...
		public ChampagneFolderCreated(Guid id, NotEmptyString folderName, AggregateId authorId, ImageId displayImageId, bool isDeleted, FolderContentType contentType, FolderType folderType, HashSet<AggregateId> champagneIds) : base(id)
		{
