...
{
    public class NotificationSettingsAdded : DomainEvent
    {
        ...
        public NotificationSettingsAdded(Guid id, bool receiveCMNotifications, bool notifyNewFollower, bool notifyNewComment, bool notifyActivityInThread, bool notifyLikeTasting, bool notifyLikeComment, bool receiveNewsLetter, bool notifyChampagneTasted, bool notifyBrandNews) : base(id)
        {
