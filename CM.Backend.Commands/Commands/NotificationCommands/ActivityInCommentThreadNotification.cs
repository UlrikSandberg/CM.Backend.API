...
{
    public class ActivityInCommentThreadNotification : Command
    {
        ...
        public ActivityInCommentThreadNotification(Guid tastingId, Guid tastingAuthorId, Guid commentedById, string commentedByName, Guid commentedByProfileImgId, string bottleName, string contextUrl)
        {
            TastingId = tastingId;
